...
- [ ] Add integration tests or assertions for HTTP/SSE route auth, DynamoDB TTL tables, KMS grants, service IAM boundaries, and rate-limit configuration. Current M8-T6 state: route inventory, DynamoDB TTL, KMS grants, IAM boundaries, and rate-limit assertions exist; real route auth assertions remain follow-up with authorizer wiring.
